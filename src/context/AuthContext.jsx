    ...
    switch (role) {
      ...
      case 'leadman':
        setUser({
          ...
          name: 'Lead Man',
          role: 'leadman',
          departments: Array.isArray(options.departments) && options.departments.length > 0 ? options.departments : [DEPARTMENTS[0]],
          department: Array.isArray(options.departments) && options.departments.length > 0 ? options.departments[0] : DEPARTMENTS[0],
        })
        break
      case 'hr':
      ...
      case 'finance':
        ...
        break
      case 'employee':
        setUser({ id: 'EMP-001', name: 'Juan Dela Cruz', role: 'employee', department: DEPARTMENTS[0] })
        break
      default:
        setUser(null)
    }
